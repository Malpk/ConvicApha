...
namespace Underworld
{
    ...
    {
        [SerializeField] public List<SettingSerilize> SettingSequnce = new List<SettingSerilize>();

        [SerializeField] public List<NodeSetting> Elements;

        [SerializeField] private List<string> SaveData = new List<string>();
