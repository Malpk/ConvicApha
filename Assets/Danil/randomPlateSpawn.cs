...
public class randomPlateSpawn : MonoBehaviour
{
    ...
    public void SpawnPlate()
    {
        ...
        if (FreePlatePlace.Length != 0)
        {
            ...
            Instantiate(plate, new Vector3(randomChoice.x, randomChoice.y,5), Quaternion.Euler(0, 0, 0));
        }
        else
        {
            Debug.Log("noChoise");
